...
int netdev_vport_flow_del(struct netdev * netdev OVS_UNUSED, const ovs_u128 * ufid OVS_UNUSED,
 ...
 * odp_port_t port - the port number allocated by dpif-netdev, matching the offload in_port.
